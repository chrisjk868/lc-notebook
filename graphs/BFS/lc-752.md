...
To help enumerate the possible lock combinations we can create an adjacency list mapping the possible numbers that each individual number could transition into.
